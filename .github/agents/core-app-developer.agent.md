...
<!-- Source: .cursor/agents/core/app-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh copilot -->
---
...
1. `.github/skills/core/monitoring-logging/SKILL.md` — Monitoring wrapping principles, PII classification, exception patterns
2. `.github/skills/core/api-design/SKILL.md` — REST conventions, pagination (hasNext)
