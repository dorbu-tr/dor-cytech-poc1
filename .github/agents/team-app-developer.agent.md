...
<!-- Source: .cursor/agents/team/app-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh copilot -->
---
...
**FIRST read**: `.github/agents/core/app-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.github/skills/team/monitoring-logging/SKILL.md` — Framework.Log, structured logging
2. `.github/skills/team/config-ccm/SKILL.md` — CCM, KeyVault, SCB configuration patterns
