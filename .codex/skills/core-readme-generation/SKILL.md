...
metadata:
  short-description: "Generate comprehensive README.md files from actual implemented code following constitution standards. Use when generating README.md, creating service documentation, building PII inventory, or documenting sensitive data. Always generate from real code in Phase 7, never from placeholders."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/core/readme-generation/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
