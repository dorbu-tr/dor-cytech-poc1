...
<!-- Source: .cursor/agents/core/test-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
...
1. `.codex/skills/core-component-testing/SKILL.md` — Component test principles, mocking strategy, test naming
2. `.codex/skills/core-system-testing/SKILL.md` — System test principles, write-only design rules
