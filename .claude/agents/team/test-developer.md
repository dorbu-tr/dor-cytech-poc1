...
<!-- Source: .cursor/agents/team/test-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
---
name: test-developer
...
**FIRST read**: `.claude/agents/core/test-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.claude/skills/team/component-testing/SKILL.md` — xUnit, FluentAssertions, Moq patterns
2. `.claude/skills/team/system-testing/SKILL.md` — System/integration test patterns
