...
metadata:
  short-description: "OpenAPI 3.0 documentation patterns including XML comments, ProducesResponseType attributes, and business-perspective descriptions. Use when implementing Swagger docs, OpenAPI specification, XML summary comments, API documentation, or adding response type annotations to controllers and DTOs."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/core/swagger-docs/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
