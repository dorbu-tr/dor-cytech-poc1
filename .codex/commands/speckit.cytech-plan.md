...
<!-- Source: .cursor/commands/speckit.cytech-plan.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
## User Input
...
- The security-review skill (`.codex/skills/core/security-review/SKILL.md`) is
  the **single source of truth** for all rules. Read it first.
- The cluster-deployment skill (`.codex/skills/core/cluster-deployment/SKILL.md`)
...
- **REQUIRED**: `.codex/skills/core/security-review/SKILL.md` — the ruleset
- **REQUIRED**: `.codex/skills/core/cluster-deployment/SKILL.md` — cluster rules
