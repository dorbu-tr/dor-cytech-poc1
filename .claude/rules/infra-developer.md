...
<!-- Source: .cursor/rules/infra-developer.mdc | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
<!-- Description: Infrastructure layer: providers, repositories, config, messaging, caching, data access -->
