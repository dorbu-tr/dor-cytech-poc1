...
<!-- Source: .cursor/agents/team/infra-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
---
...
**FIRST read**: `.claude/agents/core/infra-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.claude/skills/team/config-ccm/SKILL.md` — CCM, KeyVault, SCB configuration patterns
2. `.claude/skills/team/rest-provider/SKILL.md` — REST providers, Polly resilience, Framework.FaultTolerance
3. `.claude/skills/team/monitoring-logging/SKILL.md` — Framework.Log, structured logging
4. `.claude/skills/team/data-repositories/SKILL.md` — MSSQL BaseRepository, stored procedures, cached repositories
...
- `.claude/skills/team/data-repositories/references/database-access.md` — Full BaseRepository, retry decorator, DbSelector

### Read if feature needs external APIs
- `.claude/skills/team/rest-provider/references/nuget-packages.md` — Complete Trading NuGet package catalog
