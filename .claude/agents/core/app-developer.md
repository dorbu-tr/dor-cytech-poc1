...
<!-- Source: .cursor/agents/core/app-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
---
name: app-developer
...
1. `.claude/skills/core/monitoring-logging/SKILL.md` — Monitoring wrapping principles, PII classification, exception patterns
2. `.claude/skills/core/api-design/SKILL.md` — REST conventions, pagination (hasNext)
