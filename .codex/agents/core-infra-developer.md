...
<!-- Source: .cursor/agents/core/infra-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
...
1. `.codex/skills/core-config-management/SKILL.md` — Configuration principles, secrets classification
2. `.codex/skills/core-rest-providers/SKILL.md` — Provider principles, naming, organization
3. `.codex/skills/core-monitoring-logging/SKILL.md` — Monitoring principles, sensitive data concepts
4. `.codex/skills/core-data-repositories/SKILL.md` — Repository patterns, Parameters/Result, folder structure
