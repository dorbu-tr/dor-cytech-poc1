...
metadata:
  short-description: "| Characteristic | Simple Worker (`trading-dotnet-worker`) | Orchestration (`this skill`) |"
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/team/orchestration/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
