...
<!-- Source: .cursor/agents/team/test-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh copilot -->
---
...
**FIRST read**: `.github/agents/core/test-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.github/skills/team/component-testing/SKILL.md` — xUnit, FluentAssertions, Moq patterns
2. `.github/skills/team/system-testing/SKILL.md` — System/integration test patterns
