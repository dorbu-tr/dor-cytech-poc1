...
**FIRST read**: `.cursor/agents/core/test-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.cursor/skills/team/component-testing/SKILL.md` — xUnit, FluentAssertions, Moq patterns
2. `.cursor/skills/team/system-testing/SKILL.md` — System/integration test patterns
