...
metadata:
  short-description: "REST provider architecture principles covering resilience patterns, health commands, provider DTOs, and circuit breaker requirements. Use when implementing REST providers, external API integrations, resilience patterns, or health commands. Team-specific implementation details live in the team rest-provider skill."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/core/rest-providers/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
