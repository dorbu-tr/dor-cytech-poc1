...
1. `.cursor/skills/core/api-controllers/SKILL.md` — Controller flow, DTO patterns, mapping
2. `.cursor/skills/core/api-design/SKILL.md` — REST conventions, pagination, versioning
3. `.cursor/skills/core/swagger-docs/SKILL.md` — OpenAPI documentation requirements
4. `.cursor/skills/core/readme-generation/SKILL.md` — README structure, PII inventory
