...
<!-- Source: .cursor/agents/team/api-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh copilot -->
---
...
**FIRST read**: `.github/agents/core/api-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.github/skills/team/api-controllers/SKILL.md` — Trading controller patterns, [AuthorizeLevel], FluentValidation, AutoMapper
2. `.github/skills/team/monitoring-logging/SKILL.md` — Framework.Log, ITicksTrail, structured logging
...
- `.github/skills/team/api-controllers/references/auth-patterns.md` — Full AppSecret + STS implementation code

### Read if feature needs Swagger
- `.github/skills/team/api-controllers/references/swagger-openapi.md` — Swagger configuration and documentation requirements

### Read if feature needs API standards compliance
- `.github/skills/team/api-controllers/references/api-standards.md` — Per-tier compliance checklist
