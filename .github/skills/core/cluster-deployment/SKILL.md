...
<!-- Source: .cursor/skills/core/cluster-deployment/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh copilot -->
---
...
- `.github/skills/team/` contains `trading-*` skill names → Trading
