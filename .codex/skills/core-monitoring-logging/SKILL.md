...
metadata:
  short-description: "Monitoring wrapper and logging discipline patterns including sensitive data annotations and PII protection. Use when implementing MonitorWrapper, observability, SensitiveData attributes, structured logging, metrics, or monitoring discipline on async service methods."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/core/monitoring-logging/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
