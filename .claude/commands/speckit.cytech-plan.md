...
<!-- Source: .cursor/commands/speckit.cytech-plan.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
...
- The security-review skill (`.claude/skills/core/security-review/SKILL.md`) is
  the **single source of truth** for all rules. Read it first.
- The cluster-deployment skill (`.claude/skills/core/cluster-deployment/SKILL.md`)
...
- **REQUIRED**: `.claude/skills/core/security-review/SKILL.md` — the ruleset
- **REQUIRED**: `.claude/skills/core/cluster-deployment/SKILL.md` — cluster rules
