---
name: "team-data-repositories"
description: "Use when implementing: MSSQL repositories, stored procedure calls, BaseRepository, retry decorators, cached repositories, Scrutor decoration, table-valued parameters, batch operations."
metadata:
  short-description: "Use when implementing: MSSQL repositories, stored procedure calls, BaseRepository, retry decorators, cached repositories, Scrutor decoration, table-valued parameters, batch operations."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/team/data-repositories/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
