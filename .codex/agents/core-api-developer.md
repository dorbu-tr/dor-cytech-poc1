...
<!-- Source: .cursor/agents/core/api-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
...
1. `.codex/skills/core-api-controllers/SKILL.md` — Controller flow, DTO patterns, mapping
2. `.codex/skills/core-api-design/SKILL.md` — REST conventions, pagination, versioning
3. `.codex/skills/core-swagger-docs/SKILL.md` — OpenAPI documentation requirements
4. `.codex/skills/core-readme-generation/SKILL.md` — README structure, PII inventory
