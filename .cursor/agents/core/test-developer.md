...
1. `.cursor/skills/core/component-testing/SKILL.md` — Component test principles, mocking strategy, test naming
2. `.cursor/skills/core/system-testing/SKILL.md` — System test principles, write-only design rules
