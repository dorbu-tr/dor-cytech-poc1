...
<!-- Source: .cursor/agents/core/app-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
...
1. `.codex/skills/core-monitoring-logging/SKILL.md` — Monitoring wrapping principles, PII classification, exception patterns
2. `.codex/skills/core-api-design/SKILL.md` — REST conventions, pagination (hasNext)
