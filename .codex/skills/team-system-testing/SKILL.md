---
name: "team-system-testing"
description: "Use when implementing: system tests, integration tests, end-to-end API tests."
metadata:
  short-description: "Use when implementing: system tests, integration tests, end-to-end API tests."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/team/system-testing/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
