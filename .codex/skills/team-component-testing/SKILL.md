---
name: "team-component-testing"
description: "Use when implementing: unit tests, component tests, xUnit test classes, FluentAssertions, Moq mocking, validator tests, mapper tests, service tests, WebApplicationFactory integration tests."
metadata:
  short-description: "Use when implementing: unit tests, component tests, xUnit test classes, FluentAssertions, Moq mocking, validator tests, mapper tests, service tests, WebApplicationFactory integration tests."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/team/component-testing/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
