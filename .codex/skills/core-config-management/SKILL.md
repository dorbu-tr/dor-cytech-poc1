...
metadata:
  short-description: "Configuration management principles covering secrets classification, configuration provider pattern, and appsettings structure. Use when implementing configuration provider, secrets management, application settings, or deciding where config values belong (secret vault vs distributed config)."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/core/config-management/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
