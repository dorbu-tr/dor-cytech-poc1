...
<!-- Source: .cursor/agents/team/app-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
...
**FIRST read**: `.codex/agents/core-app-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.codex/skills/team-monitoring-logging/SKILL.md` — Framework.Log, structured logging
2. `.codex/skills/team-config-ccm/SKILL.md` — CCM, KeyVault, SCB configuration patterns
