...
<!-- Source: .cursor/agents/core/infra-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
---
...
1. `.claude/skills/core/config-management/SKILL.md` — Configuration principles, secrets classification
2. `.claude/skills/core/rest-providers/SKILL.md` — Provider principles, naming, organization
3. `.claude/skills/core/monitoring-logging/SKILL.md` — Monitoring principles, sensitive data concepts
4. `.claude/skills/core/data-repositories/SKILL.md` — Repository patterns, Parameters/Result, folder structure
