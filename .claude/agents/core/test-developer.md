...
<!-- Source: .cursor/agents/core/test-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
---
name: test-developer
...
1. `.claude/skills/core/component-testing/SKILL.md` — Component test principles, mocking strategy, test naming
2. `.claude/skills/core/system-testing/SKILL.md` — System test principles, write-only design rules
