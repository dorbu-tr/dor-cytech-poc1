---
name: "team-config-ccm"
description: "Use when implementing: configuration classes, CCM (etcd) config, KeyVault secrets, SCB (Service Config Broker), RegisterAutoUpdatedConfiguration, appsettings.json, environment-specific config."
metadata:
  short-description: "Use when implementing: configuration classes, CCM (etcd) config, KeyVault secrets, SCB (Service Config Broker), RegisterAutoUpdatedConfiguration, appsettings.json, environment-specific config."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/team/config-ccm/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
