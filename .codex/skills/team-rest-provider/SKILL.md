---
name: "team-rest-provider"
description: "Use when implementing: external API integrations, REST providers, Polly resilience pipelines, circuit breaker, retry policies, timeout policies, health checks for external dependencies."
metadata:
  short-description: "Use when implementing: external API integrations, REST providers, Polly resilience pipelines, circuit breaker, retry policies, timeout policies, health checks for external dependencies."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/team/rest-provider/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
