...
<!-- Source: .cursor/rules/api-developer.mdc | Regenerate: .specify/scripts/sh/sync-ai-rules.sh claude-code -->
<!-- Description: API layer: controllers, DTOs, validation, Swagger, route conventions -->
