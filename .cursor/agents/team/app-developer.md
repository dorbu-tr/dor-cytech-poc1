...
**FIRST read**: `.cursor/agents/core/app-developer.md` for architecture standards.

Then read these team skills for Trading-specific code examples:
1. `.cursor/skills/team/monitoring-logging/SKILL.md` — Framework.Log, structured logging
2. `.cursor/skills/team/config-ccm/SKILL.md` — CCM, KeyVault, SCB configuration patterns
