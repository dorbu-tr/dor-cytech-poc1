---
name: "team-monitoring-logging"
description: "Use when implementing: logging, structured logging, Framework.Log ILogger, LoggerWrapper, IMetrics metrics, ITicksTrail latency tracking, log4net configuration, DI registration for loggers."
metadata:
  short-description: "Use when implementing: logging, structured logging, Framework.Log ILogger, LoggerWrapper, IMetrics metrics, ITicksTrail latency tracking, log4net configuration, DI registration for loggers."
---

<!-- AUTO-GENERATED from .cursor/ canonical source. Do not edit directly. -->
<!-- Source: .cursor/skills/team/monitoring-logging/SKILL.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh codex -->
