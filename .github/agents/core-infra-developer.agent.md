...
<!-- Source: .cursor/agents/core/infra-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh copilot -->
---
...
1. `.github/skills/core/config-management/SKILL.md` — Configuration principles, secrets classification
2. `.github/skills/core/rest-providers/SKILL.md` — Provider principles, naming, organization
3. `.github/skills/core/monitoring-logging/SKILL.md` — Monitoring principles, sensitive data concepts
4. `.github/skills/core/data-repositories/SKILL.md` — Repository patterns, Parameters/Result, folder structure
