...
<!-- Source: .cursor/agents/core/api-developer.md | Regenerate: .specify/scripts/sh/sync-ai-rules.sh copilot -->
---
...
1. `.github/skills/core/api-controllers/SKILL.md` — Controller flow, DTO patterns, mapping
2. `.github/skills/core/api-design/SKILL.md` — REST conventions, pagination, versioning
3. `.github/skills/core/swagger-docs/SKILL.md` — OpenAPI documentation requirements
4. `.github/skills/core/readme-generation/SKILL.md` — README structure, PII inventory
